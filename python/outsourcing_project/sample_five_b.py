...
class PrintTable(object):
    ...
    def Preview(self):
        ...
        text = self.parentFrame.tc.GetValue()

        printout = SetPrintout(self, text)
        printout2 = SetPrintout(self, text)
...
class Frame(wx.Frame):
    ...
    def CreateCtrls(self):
        ...
        text = ('This the first line of text.\n'\
                'This is the second line and the third. The fourth will be the number 4.0.\n'\
                '4.0\n'\
    ...
    def CreatePrintData(self):
        ...
        self.ptbl = PrintTable(self)
        self.ptbl.SetHeader('This is the test HEADER')
        self.ptbl.SetFooter()

        #... but, if labels or columns are defined, a single sequence will print out as a single row
        self.ptbl.label = ('One','Two','Three','Four','5')
    ...
    def OnPrintPreview(self, event):
        ...
        resultat = text.splitlines()
        self.ptbl.data = (resultat)
        self.ptbl.Preview()
