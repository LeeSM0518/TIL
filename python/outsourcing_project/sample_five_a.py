...
#-------------------------------------------------------------------------------
# Link:
# https://raw.githubusercontent.com/wxWidgets/wxPython/master/wx/lib/printout.py
#-------------------------------------------------------------------------------
# Release Notes :
...
class Frame(wx.Frame):
    ...
    def SetProperties(self):
        ...
        self.SetTitle("Dummy wx frame for testing printout.py")
    ...
    def CreateCtrls(self):
        ...
        self.testgrid = grid.Grid(self.panel, -1,
                                  style=wx.BORDER_THEME)
        self.testgrid.CreateGrid(5, 5)
        for i in range(5):
            d = i + 1
            self.testgrid.SetColLabelValue(i, 'Column %d' % d)
            self.testgrid.SetRowLabelValue(i, 'Row %d' % d)
            for j in range(5):
                e = j + 1
                self.testgrid.SetCellValue(i, j, 'Cell %02d.%02d' % (d, e))
        self.testgrid.SetCellBackgroundColour(0, 0, wx.RED)
        self.testgrid.SetCellBackgroundColour(4, 4, wx.GREEN)
        self.testgrid.SetCellBackgroundColour(3, 4, wx.BLUE)
        self.testgrid.SetCellBackgroundColour(4, 3, wx.YELLOW)
        self.testgrid.SetColSize(0, 71)
        self.testgrid.SetColSize(1, 71)
        self.testgrid.SetColSize(2, 107)
        self.testgrid.SetColSize(3, 130)
        self.testgrid.SetColSize(4, 130)
    ...
    def CreatePrintData(self):
        ...
        testgrid = self.testgrid

        #------------

        self.grdprt = PrintGrid(self, testgrid, rowLabels=False, colLabels=False)
        ...
        self.table.SetHeader('This is the test HEADER')
    ...
    def BindEvents(self):
        ...
        self.Bind(wx.EVT_BUTTON, self.OnPrintPreview, self.btnPreview)
    ...
    def DoLayout(self):
        ...
        mainSizer.Add(self.testgrid, 0, wx.ALL, 15)
