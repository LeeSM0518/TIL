...
sample_html = """<html>
<body>
<h2><FONT COLOR=\"blue\">Sample printing </FONT></h2>
<p><B>Vestibulum</B> in tellus non nunc mollis sagittis sit amet ac purus.
Nam convallis vulputate tortor nec elementum. Nunc dictum accumsan
arcu ut lacinia. Nullam enim neque, consequat quis bibendum vitae,
gravida nec arcu. Nullam molestie dapibus sapien quis consectetur.
Donec lacinia, ante non faucibus ornare, purus sapien venenatis
turpis, ut eleifend lorem purus eu nisl. Pellentesque eget leo a augue
ullamcorper interdum at et nibh. Sed aliquet convallis dui, id
condimentum orci viverra ac. Morbi quis mauris nisl, vel malesuada
libero. Nam eleifend odio velit. Nulla vulputate facilisis mi
tincidunt tempus. Nam eu metus elit. <B>Vestibulum</B> ante ipsum primis in
faucibus orci luctus et ultrices posuere cubilia Curae; <B>Vestibulum</B> eu
risus accumsan leo egestas rutrum vitae in urna. Morbi diam orci,
eleifend a tempor sit amet, cursus sit amet est.</p>
<p><FONT COLOR=\"red\">WxPython </FONT><B>HtmlEasyPrinting </B>test.</p>
</body>
</html>"""
